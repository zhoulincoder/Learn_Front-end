        ...
        <ul>
          <li v-for="(item, index) in goods" :key="index" class="food-list" ref="foodList">
            ...
            <ul>
              ...
              class="food-item border-1px" @click="selectFood(index, $evnet)">
                <div class="icon">
...
export default {
  ...
  created() {
    ...
    this.$http.get("https://www.easy-mock.com/mock/5d00f4f64dc8d904a40b1806/eleme/goods")
      .then(res => {
        // console.log(res)
        if (res.data.errno === 0) {
